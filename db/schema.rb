...
ActiveRecord::Schema.define(version: 20_191_220_123_233) do
  ...
  create_table 'conversation_parts', force: :cascade do |t|
    ...
    t.index %w[authorable_type authorable_id], name: 'index_conversation_parts_on_authorable_type_and_authorable_id'
    ...
    t.index %w[messageable_type messageable_id], name: 'index_conversation_parts_on_messageable_type_and_messageable_id'
  ...
  create_table 'metrics', force: :cascade do |t|
    ...
    t.index %w[trackable_type trackable_id], name: 'index_metrics_on_trackable_type_and_trackable_id'
  end
