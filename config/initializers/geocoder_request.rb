...
ActionDispatch::Request.include GeocoderRequestOverride if defined?(ActionDispatch::Request)
Rack::Request.include GeocoderRequestOverride if defined?(Rack::Request)
