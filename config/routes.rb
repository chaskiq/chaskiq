...
Rails
  ...
  .draw do
    ...
    #     user,
    #     Chaskiq::Config.get('ADMIN_EMAIL')
    #   ) &
    #     ActiveSupport::SecurityUtils.secure_compare(
    #       password.to_s,
    #       Chaskiq::Config.get('ADMIN_PASSWORD').to_s
    #     )
    # end
    ...
    scope path: '/api' do
      scope path: '/v1' do
        ...
        post 'hooks/global/:provider' =>
               'api/v1/hooks/provider#global_process_event'
        get 'hooks/global/:provider' =>
              'api/v1/hooks/provider#global_process_event'
        ...
        resources :direct_uploads,
                  only: [:create],
                  controller: 'api/v1/direct_uploads'

        resources :subscription_hooks,
                  only: [:create],
