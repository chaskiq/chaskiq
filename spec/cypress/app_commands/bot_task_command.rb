...
attributes = {
  "title"=>"oother", "state"=>"enabled", 
  "predicates"=>[
    {"type"=>"match", "value"=>"and", "attribute"=>"match", "comparison"=>"and"}, 
    {"type"=>"string", "value"=>"Visitor", "attribute"=>"type", "comparison"=>"eq"}], 
  "app_id"=>1, 
  "settings"=>{}, 
  "paths"=>[{"id"=>"a7ca74ba-91a1-490d-9ee4-4f003f8346c3", "steps"=>[{"step_uid"=>"821370d6-ab07-4639-88e0-9189812dc7c0", "type"=>"messages", "messages"=>[{"app_user"=>{"display_name"=>"bot", "email"=>"bot@chasqik.com", "id"=>1, "kind"=>"agent"}, 
    ...
    "serialized_content"=>"{\"blocks\":[{\"key\":\"9oe8n\",\"text\":\"four\",\"type\":\"unstyled\",\"depth\":0,\"inlineStyleRanges\":[],\"entityRanges\":[],\"data\":{}}],\"entityMap\":{}}", "html_content"=>"--***--"}]}], "title"=>"oijioj", "follow_actions"=>nil}],
  "type"=>"leads", 
"position"=>3
}
