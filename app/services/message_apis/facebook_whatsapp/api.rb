...
module MessageApis::FacebookWhatsapp
  class Api < MessageApis::BasePackage
    include MessageApis::Helpers

    PROVIDER = "facebook_whatsapp"
    ...
    def validate_hook(params, _package)
      params["hub.challenge"]
    end

    def enqueue_process_event(params, package)
      return validate_hook(params, package) if params["hub.challenge"].present?
