          ...
          title={
            <div className="bg-gray-50">
              {subscription && (
                ...
                >
                  <h2
                    className="text-3xl leading-9 font-extrabold tracking-tight
                                text-gray-900 sm:text-3xl sm:leading-10"
                  >
                    {I18n.t('subscriptions.billing_information.title')}
                    <br />
                    <span className="text-indigo-600">
                      {I18n.t('subscriptions.billing_information.description', {
                      ...
                      {subscription.next_payment && (
                        <span className="text-2xl text-gray-800">
                          {I18n.t(
                            'subscriptions.billing_information.next_billing',
                            {
                ...
                <p className="text-sm leading-5 text-gray-500 dark:text-gray-300">
                  {
                    <span
                      dangerouslySetInnerHTML={{
                        __html: I18n.t(
                          'subscriptions.update_subscription.billed_on',
                          {
      ...
      <div className="hidden lg:block">
        <table className="w-full h-px table-fixed">
          ...
          <thead>
            <tr>
              <th
                className="pb-4 pl-6 pr-6 text-sm font-medium text-gray-900 dark:text-gray-100 text-left"
                scope="col"
              >
