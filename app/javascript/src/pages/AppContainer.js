...
const CableApp = {
  cable: actioncable.createConsumer('ws://localhost:3000/cable') //(window.ws_cable_url)
}
        ...
        isAuthenticated && current_user.email &&
          <div className="flex flex-col w-0 flex-1 overflow-auto">
            <div className="md:hidden pl-1 pt-1 sm:pl-3 sm:pt-3">
              ...
              <button onClick={handleSidebar} className="-ml-0.5 -mt-0.5 h-12 w-12 inline-flex items-center justify-center rounded-md text-gray-500 hover:text-gray-900 focus:outline-none focus:bg-gray-200 transition ease-in-out duration-150">
...
function mapStateToProps(state) {
  const { auth , drawer, app, segment, app_user, app_users, current_user, navigation } = state
