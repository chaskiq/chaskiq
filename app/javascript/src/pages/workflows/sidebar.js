  ...
  return (
    <aside className="h-screen w-72 px-4 divide-y divide-gray-200 sm:px-6 space-y-1.5">
				...
				<div>
					...
					<li className="text-md font-medium text-gray-900 pt-4--">Messages to send</li>
					...
					<li className="text-md font-medium text-gray-900 pt-4--">Actions to take</li>
...
function DefaultNode ({ onDragStart, kind, children, color }) {
  ...
  return (
    <li className={`${kind} flex shadow-sm rounded-md`} draggable onDragStart={onDragStart}>
