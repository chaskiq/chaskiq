...
const SubmitButton = function(props){
  return <button
          className={"w-1/12 bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-3 border-l border-gray-400 shadow"}
...
export default class ChatEditor extends Component {
  ...
  isDisabled = ()=>{
    return this.state.html ==="<p className=\"graf graf--p\"></p>" || this.state.disabled
  }
