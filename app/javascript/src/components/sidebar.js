...
function mapStateToProps(state) {
  const { auth , drawer, app, segment, app_users, current_user, navigation } = state
...
function Sidebar({app, 
                  ...
                  {                
                    children.map(({ id: childId, label, icon, active, url, onClick , render }) => (
                      ...
                      <Link 
                        ...
                        to={url} 
                        className={`
                        ${active ? 'bg-white' : ''} hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:bg-gray-200
  ...
  const drawerClass = !drawer.open ? 
    'hidden' : 'absolute flex md:flex-shrink-0 z-50 h-screen'


  return <div className={`${drawerClass} md:flex md:flex-shrink-0`}>

          {
            app && 
          
            <div className={`md:block border-r bg-gray-200 text-purple-lighter flex-none w-23 p-2 overflow-y-auto--`}>
          ...
          <div className="md:flex flex-col w-56 border-r border-gray-200 bg-gray-100">
            ...
            {/*<a href="#" className="group flex items-center px-2 py-2 text-sm leading-5 font-medium text-gray-900 rounded-md bg-gray-100 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:bg-gray-200 transition ease-in-out duration-150">
                ...
                <a href="#" className="mt-1 group flex items-center px-2 py-2 text-sm leading-5 font-medium text-gray-600 rounded-md hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:bg-gray-100 transition ease-in-out duration-150">
                ...
                <div className="flex items-center">
                  <div>
                    <img className="inline-block h-9 w-9 rounded-full" 
                      src={current_user.avatarUrl} alt=""
                      width={40}
                      height={40} />
                  </div>
                  <div className="ml-3">
