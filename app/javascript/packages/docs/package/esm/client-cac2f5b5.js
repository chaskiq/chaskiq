import { o as objectAssign, R as React, r as react } from './index-ef03c8d2.js';
...
function z(a){if("object"===typeof a&&null!==a){var u=a.$$typeof;switch(u){case c:switch(a=a.type,a){case l:case m$1:case e:case g:case f:case p:return a;default:switch(a=a&&a.$$typeof,a){case k:case n:case t:case r:case h$1:return a;default:return u}}case d$1:return u}}}function A(a){return z(a)===m$1}reactIs_production_min.AsyncMode=l;reactIs_production_min.ConcurrentMode=m$1;reactIs_production_min.ContextConsumer=k;reactIs_production_min.ContextProvider=h$1;reactIs_production_min.Element=c;reactIs_production_min.ForwardRef=n;reactIs_production_min.Fragment=e;reactIs_production_min.Lazy=t;reactIs_production_min.Memo=r;reactIs_production_min.Portal=d$1;
...
reactIs_production_min.isValidElementType=function(a){return "string"===typeof a||"function"===typeof a||a===e||a===m$1||a===g||a===f||a===p||a===q||"object"===typeof a&&null!==a&&(a.$$typeof===t||a.$$typeof===r||a.$$typeof===h$1||a.$$typeof===k||a.$$typeof===n||a.$$typeof===w$1||a.$$typeof===x||a.$$typeof===y$1||a.$$typeof===v)};reactIs_production_min.typeOf=z;
...
function (_React$Component) {
  _inheritsLoose$2(Router, _React$Component);
...
/*#__PURE__*/
function (_React$Component) {
  _inheritsLoose$2(MemoryRouter, _React$Component);
...
/*#__PURE__*/
(function (_React$Component) {
  _inheritsLoose$2(Lifecycle, _React$Component);
...
/*#__PURE__*/
function (_React$Component) {
  _inheritsLoose$2(Route, _React$Component);
...
/*#__PURE__*/
function (_React$Component) {
  _inheritsLoose$2(StaticRouter, _React$Component);
...
/*#__PURE__*/
function (_React$Component) {
  _inheritsLoose$2(Switch, _React$Component);
...
RedirectableRequest.prototype.abort = function () {
  ...
  this._currentRequest.on("error", noop$2);
...
var persistState$1 = {exports: {}};

var createSlicer = {exports: {}};

var getSubset = {exports: {}};
...
var _getSubsetJs = getSubset.exports;

var _getSubsetJs2 = _interopRequireDefault(_getSubsetJs);

var _utilTypeOfJs = typeOf.exports;
...
module.exports = exports['default'];
}(createSlicer, createSlicer.exports));

var mergeState = {exports: {}};
...
var _createSlicerJs = createSlicer.exports;

var _createSlicerJs2 = _interopRequireDefault(_createSlicerJs);

var _utilMergeStateJs = mergeState.exports;
...
module.exports = exports['default'];
}(persistState$1, persistState$1.exports));

var persistState = /*@__PURE__*/getDefaultExportFromCjs(persistState$1.exports);
...
function setMessage(data) {
  return {
    type: actionTypes.SetStatusMessage,
    data: data
  };
}

var initialState$c = {}; // Reducer
...
function reducer$f(state) {
  var action = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var initialState = {}; // Actions

  var SET_CURRENT_USER = 'auth/SET_CURRENT_USER';
...
var RECEIVED = 'auth/RECEIVED';
var SIGNOUT = 'auth/SIGNOUT';
function successAuthentication(accessToken, refreshToken) {
...
function reducer$e(state) {
  var action = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var REQUEST = 'auth/REQUEST';
  var RECEIVED = 'auth/RECEIVED';
  var FAILED = 'auth/FAILED';
  var SIGNOUT = 'auth/SIGNOUT';
  var initialState = {
    loading: false,
  ...
  switch (action.type) {
    ...
    case RECEIVED:
      return Object.assign({}, state, {
        ...
        refreshToken: action.data.refresh_token // jwt: action.jwt,
...
var initialState$b = null; // Reducer
...
function setLockPage(data) {
  return {
    type: actionTypes.SetUpgradePage,
    data: data
  };
}

var initialState$5 = {}; // Reducer
...
new Audio('/sounds/BLIB.wav');
var initialState$4 = {}; // Reducer
    ...
    case actionTypes.UpdateConversationItem:
      {
        return _objectSpread2$1(_objectSpread2$1({}, state), {}, {
          collection: state.collection.map(function (item) {
            return item.id === action.data.id ? _objectSpread2$1(_objectSpread2$1({}, item), action.data) : item;
          })
        });
      }
...
function reducer$3() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : navigationState;
  var action = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
var initialState$1 = 'light'; // Reducer
...
var subscriptionState = {}; // Reducer

function reducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : subscriptionState;
  var action = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
var rootReducer = combineReducers({
  ...
  app_users: reducer$b,
  app_user: reducer$a,
  conversation: reducer$6,
  conversations: reducer$5,
  current_user: reducer$f,
  status_message: reducer$g,
  ...
  rtc: reducer$9,
  campaigns: reducer$8,
  paddleSubscription: reducer,
  upgradePages: reducer$7
});
var middlewares = [thunk]; //, routerMiddleware(history)]

var enhancer = compose$1(applyMiddleware.apply(void 0, middlewares), persistState('auth', {
  key: 'AUTH'
}), persistState('current_user', {
  key: 'CURRENT_USER'
}), persistState('theme', {
  key: 'THEME'
}));
var store = createStore(rootReducer, composeWithDevTools(enhancer));

var graphql = function graphql(query, variables, callbacks) {
  var _store$getState = store.getState(),
      auth = _store$getState.auth,
      current_user = _store$getState.current_user;

  var locale = current_user.lang || I18n.defaultLocale;
  var config = {
  ...
  axios.create({
    ...
    switch (req.response.status) {
      ...
      case 402:
        //
        store.dispatch(lockPage(req.response.data.error.message)); // store.dispatch(errorMessage('server error ocurred'))
      ...
      case 401:
        ...
        store.dispatch(refreshToken(auth)); // store.dispatch(expireAuthentication())
        // refreshToken(auth)
...
export { ARTICLE_SETTINGS as A, BrowserRouter as B, Link as L, PropTypes as P, Route as R, Switch as S, _taggedTemplateLiteral as _, _objectWithoutProperties as a, _extends as b, _slicedToArray as c, commonjsGlobal$1 as d, _inherits as e, _createSuper as f, graphql as g, hoistNonReactStatics_cjs as h, _createClass as i, _classCallCheck as j, ARTICLE as k, _setPrototypeOf$2 as l, ARTICLE_COLLECTION_WITH_SECTIONS as m, ARTICLE_COLLECTIONS as n, SEARCH_ARTICLES as o, commonjsRequire as p, getDefaultExportFromCjs as q, reactIs$1 as r };
