...
const OnDemandTriggersBlockConfig = (options: {}) => {
  const config = {
    ...
    icon: () => (
      <svg viewBox="0 0 15 18" className="w-4 h-4" fill="none" xmlns="http://www.w3.org/2000/svg" width="15" height="15">
        <path d="M7.5 2.5a5 5 0 015 5v6a1 1 0 01-1 1h-8a1 1 0 01-1-1v-6a5 5 0 015-5zm0 0V0M4 11.5h7M.5 8v4m14-4v4m-9-2.5a1 1 0 110-2 1 1 0 010 2zm4 0a1 1 0 110-2 1 1 0 010 2z" stroke="currentColor">
        </path>
      </svg>
    ),
